...
CREATE TABLE IF NOT EXISTS SIZCARDPERSONAL (
    ...
    CONSTRAINT FK_SIZCARDPERSONAL_ITEMID   FOREIGN KEY (ITEMID)   REFERENCES SIZNORMITEM(ITEMID)   ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS SIZCARDPERSONALLOG (
    ...
    SINGLECOMPLECT INTEGER  NOT NULL DEFAULT 0,
    ...
    CONSTRAINT FK_SIZCARDPERSONALLOG_GETTINGDOCID  FOREIGN KEY (GETTINGDOCID)  REFERENCES SIZDOC(DOCID)              ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT FK_SIZCARDPERSONALLOG_GETTINGINFOID FOREIGN KEY (GETTINGINFOID) REFERENCES SIZNORMSUBITEMINFO(INFOID) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS SIZCARDPERSONALLOGINFO (
    ...
    CONSTRAINT FK_SIZCARDPERSONALLOGINFO_STOREID FOREIGN KEY (STOREID) REFERENCES SIZSTORE(STOREID)           ON UPDATE CASCADE ON DELETE CASCADE
);
