...
CREATE TABLE IF NOT EXISTS SIZCARDPERSONALLOG (
    ...
    RECEIVINGDOCID  INTEGER  NOT NULL,
    ...
    CONSTRAINT FK_SIZCARDPERSONALLOG_RECEIVINGDOCID  FOREIGN KEY (RECEIVINGDOCID)  REFERENCES SIZDOC(DOCID)              ON UPDATE CASCADE ON DELETE CASCADE,
