...
CREATE TABLE IF NOT EXISTS SIZSTAFFWRITEOFF (
    WRITEOFFID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    DOCID      INTEGER NOT NULL,
    STOREID    INTEGER NOT NULL,
    ENTRYID    INTEGER NOT NULL DEFAULT 0,
    NOTE       TEXT   ,
    CONSTRAINT FK_SIZSTAFFWRITEOFF_DOCID   FOREIGN KEY (DOCID)   REFERENCES SIZDOC(DOCID)        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT FK_SIZSTAFFWRITEOFF_STOREID FOREIGN KEY (STOREID) REFERENCES SIZSTORELOG(STOREID) ON UPDATE CASCADE ON DELETE CASCADE
);
