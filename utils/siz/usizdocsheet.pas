  ...
  private
    const
      ...
      COLWIDTHS: array of Integer = (
        ...
        {03} 20,  //ФИО 2
        {04} 80,  //таб номер
        {05} 15,  //наименование СИЗ 1
        {06} 70,  //наименование СИЗ 2
        {07} 15,  //наименование СИЗ 3
        {08} 125, //наименование СИЗ 4
        {09} 40,  //номенкл номер 1
        {10} 80,  //номенкл номер 2
        {11} 40,  //код ед. изм
        {12} 60,  //наимен ед изм 1
        {13} 35,  //наимен ед изм 2
        {14} 40,  //кол-во 1
        {15} 15,  //кол-во 2
        {16} 75,  //дата поступления в эксплуатацию 1
