...
const
  ...
  OTHER_DESCRIPTION: array of String = (
    ...
    {07} ' - [ДОКУМЕНТЫ ПОСТУПЛЕНИЯ СИЗ НА СКЛАД]',
    {08} ' - [ДОКУМЕНТЫ ВЫДАЧИ СИЗ СОТРУДНИКАМ]',
    {09} ' - [ДОКУМЕНТЫ СПИСАНИЯ СИЗ СО СКЛАДА]',
    {10} ' - [ДОКУМЕНТЫ ВОЗВРАТА СИЗ СОТРУДНИКАМИ НА СКЛАД]',
  ...
  **************************************************************************)
  ...
  SETTING_NAMES_SCHEDULEPERSONALMONTHFORM: array of String  =  (
    ...
    'SCHEDULEPERSONALMONTHFORM.NEEDRANKS',
