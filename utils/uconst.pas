...
const
  ...
  **************************************************************************)
  ...
  SIZ_TYPE_PICKS: array of String  =
    ('Одежда специальная защитная', 'Средства защиты ног', 'Средства защиты головы', 'Средства защиты рук', 'Средства защиты глаз', 'Средства защиты органов дыхания', 'Средства защиты органов слуха', 'Средства дерматологические');
