      ...
      1: //форма T-12
        begin
          ...
          SheetT12.Draw(Company,Department, MonthCalendar, Timetables,
                 StaffNames, TabNums, PostNames, Ranks,
...
var
  ...
  begin
    ExpSheet:= TMonthTimetableSheet.Create(Worksheet, nil, GridFont,
                                              ...
                                              ParamList.Checkeds['ExtraColumns']);
    try
      ExpSheet.Draw(MonthCalendar, StaffNames, TabNums, PostNames, Ranks, NormHours,
                   ParamList.Checkeds['ViewParams'],
                   ParamList.Checkeds['ExportParams'],
                   Timetables, BeforeTotalHours, BeforeNightHours,
                   ParamList.Selected['MonthType']=0)
  ...
  begin
    ...
    try
      ExpSheetT12.Draw(Company,Department, MonthCalendar,
                   Timetables, StaffNames, TabNums, PostNames, Ranks,
                   ParamList.Checked['ViewParams', 2],
                   ParamList.Selected['ViewType']=0,
                   ParamList.Selected['MonthType']=0,
                   ParamList.Checkeds['ExportParams'],
