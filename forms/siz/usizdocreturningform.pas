...
procedure TSIZDocReturningForm.MB7ButtonClick(Sender: TObject);
begin
  SIZDocMB7FormOpen(DocID, True{возврат});
end;
...
procedure TSIZDocReturningForm.SetButtonsEnabled(const AEnabled: Boolean);
begin
